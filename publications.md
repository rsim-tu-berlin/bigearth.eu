...
<div class="bg-faded p-4 my-4">
	<div class="bg-faded p-4 my-4">
		<p>
			<b>Note:</b> This publication list includes only BigEarth-related publications. For the full list, please <a href="https://rsim.berlin/publications" target="_blank">see</a>. PDFs given in this web page are the authors' draft versions of the related papers. For the whole list of the software developed and maintained at our group, please visit <a href="https://rsim.berlin/software" target="_blank">here</a>.
		</p>
		<hr />
		<div class="row">
			<div class="col-lg-3 col-lg-12-pull">
				<img class="publication-image mx-auto d-block" src="assets/publications/images/2023-journals-3.png">
			</div>
			<div class="col-lg-9 col-lg-12-push">
				<span class="publication-title">Deep Active Learning for Multi-Label Classification of Remote Sensing Images</span><br />
				Lars Möllenbrok, Gencer Sumbul, Begüm Demir<br />
				IEEE Geoscience and Remote Sensing Letters, 2023.<br />
				<a class="publication-icon" href="https://arxiv.org/abs/2212.01165" target="_blank"><i class="fa fa-file-pdf-o text-color-be"></i></a>
			</div>
		</div>
		<hr />
		<div class="row">
			<div class="col-lg-3 col-lg-12-pull">
				<img class="publication-image mx-auto d-block" src="assets/publications/images/2023-journals-2.png">
			</div>
			<div class="col-lg-9 col-lg-12-push">
				<span class="publication-title">Generative Reasoning Integrated Label Noise Robust Deep Image Representation Learning</span><br />
				Gencer Sumbul, Begüm Demir<br />
				IEEE Transactions on Image Processing, 2023.<br />
				<a class="publication-icon" href="https://arxiv.org/abs/2212.01261" target="_blank"><i class="fa fa-file-pdf-o text-color-be"></i></a>
				<a class="publication-icon" href="https://github.com/gencersumbul/GRID" target="_blank"><i class="fa fa-github text-color-be"></i></a>
			</div>
		</div>
		<hr />
		<div class="row">
			<div class="col-lg-3 col-lg-12-pull">
				<img class="publication-image mx-auto d-block" src="assets/publications/images/2023-conferences-11.png">
			</div>
			<div class="col-lg-9 col-lg-12-push">
				<span class="publication-title">LIT-4-RSVQA: Lightweight Transformer-based Visual Question Answering in Remote Sensing</span><br />
				Leonard Hackel*, Kai Norman Clasen*, Mahdyar Ravanbakhsh, Begüm Demir<br />
				 IEEE International Geoscience and Remote Sensing Symposium, Pasadena, California, 2023.<br />
				<a class="publication-icon" href="https://arxiv.org/abs/2306.00758" target="_blank"><i class="fa fa-file-pdf-o text-color-be"></i></a>
				<a class="publication-icon" href="https://git.tu-berlin.de/rsim/lit4rsvqa" target="_blank"><i class="fa fa-gitlab text-color-be"></i></a>
			</div>
		</div>
		<hr />
		<div class="row">
			<div class="col-lg-3 col-lg-12-pull">
				<img class="publication-image mx-auto d-block" src="assets/publications/images/2023-conferences-10.png">
			</div>
			<div class="col-lg-9 col-lg-12-push">
				<span class="publication-title">Label Noise Robust Image Representation Learning based on Supervised Variational Autoencoders in Remote Sensing</span><br />
				Gencer Sumbul, Begüm Demir<br />
				 IEEE International Geoscience and Remote Sensing Symposium, Pasadena, California, 2023.<br />
				<a class="publication-icon" href="https://arxiv.org/abs/2306.08575" target="_blank"><i class="fa fa-file-pdf-o text-color-be"></i></a>
				<a class="publication-icon" href="https://git.tu-berlin.de/rsim/RS-IRL-SVAE" target="_blank"><i class="fa fa-gitlab text-color-be"></i></a>
			</div>
		</div>
		<hr />
		<div class="row">
			<div class="col-lg-3 col-lg-12-pull">
				<img class="publication-image mx-auto d-block" src="assets/publications/images/2023-conferences-09.png">
			</div>
			<div class="col-lg-9 col-lg-12-push">
				<span class="publication-title">Transformer-based Multi-Modal Learning for Multi-Label Remote Sensing Image Classification</span><br />
				David Sebastian Hoffmann*, Kai Norman Clasen*, Begüm Demir<br />
				 IEEE International Geoscience and Remote Sensing Symposium, Pasadena, California, 2023.<br />
				<a class="publication-icon" href="https://arxiv.org/abs/2306.01523" target="_blank"><i class="fa fa-file-pdf-o text-color-be"></i></a>
				<a class="publication-icon" href="https://git.tu-berlin.de/rsim/sct-fusion" target="_blank"><i class="fa fa-gitlab text-color-be"></i></a>
			</div>
		</div>
		<hr />
		<div class="row">
			<div class="col-lg-3 col-lg-12-pull">
				<img class="publication-image mx-auto d-block" src="assets/publications/images/2023-conferences-08.png">
			</div>
			<div class="col-lg-9 col-lg-12-push">
				<span class="publication-title">Learning Across Decentralized Multi-Modal Remote Sensing Archives with Federated Learning</span><br />
				Barış Büyüktaş, Gencer Sumbul, Begüm Demir<br />
				 IEEE International Geoscience and Remote Sensing Symposium, Pasadena, California, 2023.<br />
				<a class="publication-icon" href="https://arxiv.org/abs/2306.00792" target="_blank"><i class="fa fa-file-pdf-o text-color-be"></i></a>
				<a class="publication-icon" href="https://git.tu-berlin.de/rsim/MM-FL" target="_blank"><i class="fa fa-gitlab text-color-be"></i></a>
			</div>
		</div>
		<hr />
		<div class="row">
			<div class="col-lg-3 col-lg-12-pull">
				<img class="publication-image mx-auto d-block" src="assets/publications/images/2023-conferences-07.png">
			</div>
			<div class="col-lg-9 col-lg-12-push">
				<span class="publication-title">HySpecNet-11k: A Large-Scale Hyperspectral Dataset for Benchmarking Learning-Based Hyperspectral Image Compression Methods</span><br />
				Martin Hermann Paul Fuchs, Begüm Demir<br />
				 IEEE International Geoscience and Remote Sensing Symposium, Pasadena, California, 2023.<br />
		...
		<div class="row">
			<div class="col-lg-3 col-lg-12-pull">
				<img class="publication-image mx-auto d-block" src="assets/publications/images/2023-conferences-06.png">
			</div>
			<div class="col-lg-9 col-lg-12-push">
				<span class="publication-title">Active Learning Guided Fine-Tuning for Enhancing Self-Supervised Based Multi-Label Classification of Remote Sensing Images</span><br />
				Lars Möllenbrok, Begüm Demir<br />
				 IEEE International Geoscience and Remote Sensing Symposium, Pasadena, California, 2023.<br />
				<a class="publication-icon" href="https://arxiv.org/abs/2306.06908" target="_blank"><i class="fa fa-file-pdf-o text-color-be"></i></a>
			</div>
		</div>
		<hr />
		<div class="row">
			<div class="col-lg-3 col-lg-12-pull">
				<img class="publication-image mx-auto d-block" src="assets/publications/images/2023-conferences-05.png">
			</div>
			<div class="col-lg-9 col-lg-12-push">
				<span class="publication-title">Annotation Cost Efficient Active Learning for Remote Sensing Image Retrieval</span><br />
				Julia Henkel, Genc Hoxha, Gencer Sumbul, Lars Möllenbrok, Begüm Demir<br />
				 IEEE International Geoscience and Remote Sensing Symposium, Pasadena, California, 2023.<br />
				<a class="publication-icon" href="https://arxiv.org/abs/2306.11605" target="_blank"><i class="fa fa-file-pdf-o text-color-be"></i></a>
    			<a class="publication-icon" href="https://git.tu-berlin.de/rsim/anneal" target="_blank"><i class="fa fa-github text-color-be"></i></a>
			</div>
		</div>
    	<hr />
    	<div class="row">
